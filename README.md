https://infognu.ansan.ac.kr/~i2251014/WebDB2025/display.php#  <br><br>

display.php   -  메인페이지<br>

travel_process.php - 추가 폼, 로직 <br>
updateForm.php     - 수정 폼 <br>
updateProcess.php  - 수정 로직 <br>
delete.php         - 삭제 <br>

join_process.php  - 로그인 회원가입 <br>
logout.php        - 로그아웃 <br>

webDB 수업에서 배운 php를 이용하여 웹사이트를 제작하였습니다.<br>
